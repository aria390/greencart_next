    ...
    <>
      {isOpen && (
        <div
          ...
          className="fixed inset-0 top-0  left-0  z-30 flex items-center justify-center bg-black/50"
        >
          {!moveToSignUP ? (
            <div
              onClick={(e) => {
            ...
            >
              <div>
                <p className="text-[24px] font-medium text-green-500">
                  User <span className="text-gray-600">Login</span>
                </p>
              </div>
              <form
              ...
              >
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="border rounded-md text-[14px] placeholder:text-gray-400 border-gray-200 w-75 p-2 outline-[#4fbf8b]"
                    type="email"
                  />
                </div>
                <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-center ">
                  <button
                    ...
                    type="submit"
                    className="bg-green-500 text-white px-32 rounded-md py-2 text-[14px] cursor-pointer "
                  >
                    Login
                  </button>
                </div>
            ...
            >
              <div>
                <p className="text-[24px] font-medium text-green-500">
                  User <span className="text-gray-600">Sign Up</span>
                </p>
              </div>
              <form
                className="flex flex-col gap-4"
                onSubmit={submitSignUP(({ email, name, password }) => {
              ...
              >
                ...
                <div className="flex justify-center ">
                  <button
                    ...
                    type="submit"
                    className="bg-green-500 text-white px-24 rounded-md py-2 text-[14px] cursor-pointer "
                  >
                    Create Account
                  </button>
                </div>
